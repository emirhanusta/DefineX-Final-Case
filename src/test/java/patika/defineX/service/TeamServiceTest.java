...
public class TeamServiceTest {
    ...
    public void setUp() {
        ...
        user = new User("Test User", "user@example.com", "password", Set.of(Role.TEAM_LEADER));
        team = new Team("Test Team", project);

    }

    @Test
    public void testGetAllTeamsByProjectId() {
    ...
    public void testGetTeamById() {
        ...
        assertEquals(1, result.members().size()); // Şimdi 1 üye bekliyoruz
    }
    ...
    @Test
    public void testUpdate_ProjectChanged() {
    ...
    @Test
    public void testDeleteTeamsByProjectId() {
