...
class IssueServiceTest {
    ...
    @Test
    void getById_ShouldThrowException_WhenIssueNotFound() {
    ...
    @Test
    void update_ShouldRemoveAssignee_WhenNull() {
        IssueUpdateRequest updateRequest = new IssueUpdateRequest(
    ...
    @Test
    void updateStatus_ShouldNotChangeStatus_WhenSameStatus() {
        IssueStatusChangeRequest statusChangeRequest = new IssueStatusChangeRequest(
    ...
    @Test
    void updateStatus_ShouldThrowException_WhenInvalidChange() {
        IssueStatusChangeRequest statusChangeRequest = new IssueStatusChangeRequest(
    ...
    @Test
    void updateStatus_ShouldThrowException_IsIssueCompleted() {
        IssueStatusChangeRequest statusChangeRequest = new IssueStatusChangeRequest(
    ...
    @Test
    void updateStatus_ShouldThrowException_WhenNoReasonProvided() {
        IssueStatusChangeRequest statusChangeRequest = new IssueStatusChangeRequest(
    ...
    @Test
    void updateStatus_ShouldThrowException_WhenIssueChangeIsInvalid() {
        IssueStatusChangeRequest statusChangeRequest = new IssueStatusChangeRequest(
    ...
    @Test
    void delete_ShouldThrowException_WhenIssueNotFound() {
        when(issueRepository.findByIdAndDeletedAtNull(issueId)).thenReturn(Optional.empty());
