...
class TokenServiceTest {
    ...
    private final int refreshExpirationTime = 86400000; // 1 gün
    ...
    @Test
    void validateRefreshToken_ShouldReturnNewTokens_WhenValid() {
    ...
    @Test
    void deleteRefreshTokenByUserId_ShouldSoftDeleteToken_WhenTokenExists() {
    ...
    @Test
    void deleteRefreshTokenByUserId_ShouldNotDeleteToken_WhenTokenDoesNotExist() {
        UUID userId = UUID.randomUUID();
    ...
    @Test
    void deleteRefreshToken_ShouldSoftDeleteToken_WhenTokenExists() {
    ...
    @Test
    void deleteRefreshToken_ShouldThrowException_WhenTokenDoesNotExist() {
        String token = UUID.randomUUID().toString();
